            ...
            {images.map((image, index) => (
              <Card
                ...
                className={`absolute w-full h-full overflow-hidden rounded-lg shadow-xl border-2 border-card transform transition-all duration-500 ease-out
                  ${index === 0 ? 'z-30 rotate-[-6deg] hover:rotate-[-4deg] hover:scale-105 translate-x-0' : ''}
                  ${index === 1 ? 'z-20 rotate-[4deg] scale-95 hover:scale-100 translate-x-6' : ''}
                  ${index === 2 ? 'z-10 rotate-[6deg] scale-90 hover:scale-95 translate-x-12' : ''}
                  hover:z-40 
                `}
              >
